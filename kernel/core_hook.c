...
// kernel 4.4 and 4.9
#if LINUX_VERSION_CODE < KERNEL_VERSION(4, 10, 0) || defined(CONFIG_IS_HW_HISI) || defined(CONFIG_KSU_ALLOWLIST_WORKAROUND) || LINUX_VERSION_CODE < KERNEL_VERSION(5, 4, 0) && defined(CONFIG_SAMSUNG_PRODUCT_SHIP)
